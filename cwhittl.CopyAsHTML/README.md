# Copy As HTML Noteplan Plugin

## Latest Updates

See [CHANGELOG](https://github.com/NotePlan/plugins/blob/main/cwhittl.CopyAsHTML/CHANGELOG.md) for latest updates/changes to this plugin.

## About This Plugin 

Allow you to copy note content as HTML to paste to other applications
